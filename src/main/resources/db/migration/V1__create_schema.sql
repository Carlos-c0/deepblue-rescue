...
CREATE TABLE rescue_cases (
                              ...
                              CONSTRAINT fk_rescue_cases_center FOREIGN KEY (rescue_center_id)
...
CREATE TABLE animals (
                         ...
                         CONSTRAINT fk_animals_rescue_case FOREIGN KEY (rescue_case_id)
...
CREATE TABLE medical_records (
                                 ...
                                 CONSTRAINT fk_medical_records_animal FOREIGN KEY (animal_id)
...
CREATE TABLE treatments (
                            ...
                            description    TEXT,
                            CONSTRAINT fk_treatments_animal FOREIGN KEY (animal_id)
                                REFERENCES animals (id),
                            CONSTRAINT fk_treatments_specialist FOREIGN KEY (specialist_id)
                                REFERENCES specialists (id)
);
